        ...
        <section id="FleetOwner">
            <div className='pt-20 pb-10 space-y-10 px-4 tablet:px-8 laptop:px-12'>
                ...
                <div className="tablet:grid hidden laptop:grid-cols-4 tablet:grid-cols-2 grid-cols-1 gap-10">
                    <img src={Fortuner} className="w-fit mx-auto opacity-60 rounded-xl" alt="TOYOTA FORTUNER 2019" />
                    <img src={Landcruiser} className="w-fit mx-auto opacity-60 rounded-xl" alt="TOYOTA LANDCRUISER VX" />
                    <img src={Prado} className="w-fit mx-auto opacity-60 rounded-xl" alt="TOYOTA PRADO 2018" />
                    <img src={Lexus} className="w-fit mx-auto opacity-60 rounded-xl" alt="LEXUS GX 460 2015" />
                </div>
