    ...
    return (
        <div>
            ...
            <section className="relative pt-20 tablet:bg-v2-hero-bg bg-cover max-h-screen bg-center">
                ...
                <div className='laptop:mt-12 mt-6 laptop:bg-opacity-10 grid backdrop-blur-sm px-6 tablet:px-8 laptop:px-12 py-6 rounded-lg bg-transparent laptop:grid-cols-4 grid-cols-2 laptop:gap-8 gap-10 justify-between'>
                    <span>
