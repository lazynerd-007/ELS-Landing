import { FooterData } from "../Home/Navbar/NavbarData";
import Logo from '../../assets/Logo.png'

const Footer = () => {
    return (
        <div>
            <footer className="bg-[#17161B] text-[#E5E7EB] py-20 border-t border-[#D1D5DB]/40 laptop:px-12 tablet:px-8 px-4 bottom-0">
                <div className="">
